...
QUBIT_COUNTS="6 20 50"

# n.b. this is actually CCZ/2 counts, since each CCZ appears twice
CCZ_COUNTS="1 2 3 4 5 10 15 20 25 30 35 40 50 60 70 80 90 100"
    ...
    for ccz in $CCZ_COUNTS; do
        ...
        for seed in $SEEDS; do
            ...
            if [ -f "hidden_shift_${qubit}_${ccz}_${seed}" ]; then
                ...
                timeout $TIMEOUT ../../target/release/examples/mod_hidden_shift_stabrank $qubit $ccz $seed
